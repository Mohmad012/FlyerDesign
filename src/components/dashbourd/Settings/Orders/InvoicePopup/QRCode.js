...
function QRCode() {
  return (
    <svg
      ...
      fill='none'
      viewBox='0 0 84 78'>
      <path fill='url(#pattern0)' d='M6 4H83V78H6z'></path>
      <rect
        width='83.7'
        height='77.7'
        x='0.15'
